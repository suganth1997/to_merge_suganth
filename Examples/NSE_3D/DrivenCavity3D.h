// Navier-Stokes problem, Driven cavity with SLIP_FRICTION_PENETRATION_RESISTANCE
// 
// u(x,y) = unknown
// p(x,y) = unknown
...
void BoundCondition(int CompID, double x, double y, double z, BoundCond &cond)
{
 switch(CompID)
  {    
    ...
    case 3: 
    case 4:
        cond = DIRICHLET; //SLIP_FRICTION_PENETRATION_RESISTANCE;
    ...
    case 5:         
      cond = DIRICHLET;
      break;
    default: cout << "wrong boundary part number: " << CompID << endl;
  }   
}
