...
int apply_integral_operator(int nx, int ny, int nz, int na, double* input, double* v, double* grad_v, double* temp, double* output, double* grid, double L_max, double f_max, double* params) {
